...
public extension String {
    ...
    func encryptAES256(key: Data, nonce: AES.GCM.Nonce = .init()) throws -> Data {
        ...
        return try Crypto.encryptAES256GCM(data: data, key: key, nonce: nonce)
    }
    ...
    func decryptAES256(key: Data) throws -> Data {
        ...
        return try Crypto.decryptAES256GCM(data: hexData, key: key)
    }
    ...
    func encryptAES256(key: Data, nonce: AES.GCM.Nonce = .init()) throws -> String {
        ...
        return try Crypto.encryptAES256GCM(data: data, key: key, nonce: nonce).toHexadecimal
    }
    ...
    func decryptAES256(key: Data) throws -> String {
        ...
        let data = try Crypto.decryptAES256GCM(data: hexData, key: key)
